...
import { selectVolume, selectDifficulty, selectSoundsAutoPlay } from '../../../redux/selectors/settings.selectors';
...
export default () => {
  ...
  const changeSoundsAutoPlay = () => dispatch(changeOption(SETTINGS_NAMES.soundsAutoPlay, !soundsAutoPlay));
  return (
    <div className="form-group">
      ...
      <div className="custom-control custom-checkbox">
        ...
        />
        <label className="custom-control-label" htmlFor="complicatedCheck">Autoplay sounds</label>
      </div>
    </div>
  );
};
