...
const TextExample = ({wordObj, isShowAnswear, setUserWord, wordImput, retfocus}) => {
    ...
    return (
        <>
            ...
            <Word wordObj={wordObj} isShowAnswear={isShowAnswear} 
            setUserWord={setUserWord} wordImput={wordImput} retfocus={retfocus}/>
